    ...
    $(function () { 
        ...
        var presenterDataFilters = {
            ...
            localStorageGetItem : function(){
               if(window.localStorage.getItem("@Inject/Filters/" + modelDataFilters.currentPathname) !== null) {
                    modelDataFilters.dataTable = JSON.parse(window.localStorage.getItem("@Inject/Filters/" + modelDataFilters.currentPathname));
               }
        ...
        var viewDataFilters = {
            ...
            remove: function(value){    
                ...
                modelDataFilters.controlSelect.append($('<option>', {
                    value: value,
                    text: text
                }));
