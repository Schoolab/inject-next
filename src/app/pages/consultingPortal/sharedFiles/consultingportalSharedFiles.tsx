...
export const consultingportalSharedFiles = () => {
        ...
        <Layout showShortcutbar={false} hub={false}>
            <main className="application-content transparent-sections">
                ...
                <div id="appMainContainer" className="h-100 overflow-y-auto overflow-x-hidden">
                    <div className="container-lg container-lg-fluid p-sm p-md-md p-lg-xl">
                        <div className="application-section">
                            <p className="m-0">
                            Upload files or links to stay aligned, explore shared Resources, and access key Deliverables from Schoolab.
                            </p>
                ...
                <div className="d-flex p-md border-top">
                    <Button type="default" label="Add files" hasDropdown={true} iconStartName="plus-circle"></Button>
                    <div className="d-flex gap-xs flex-fill justify-content-end">
                        <Button type="default" label="Select all"></Button>
                        <Button type="primary" label="dowwnload" iconStartName="download"></Button>
                    </div>
                </div>
            </main>
        </Layout>
