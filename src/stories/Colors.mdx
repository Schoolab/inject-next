...
<ColorPalette>
  <ColorItem
    ...
    colors={{ 
        ...
        Highlight: 'var(--bg-interactive-light)', 
        HighlightHover: 'var(--bg-interactive-light-hover)',
    }}
  />
  <ColorItem
    title="Accent"
...
<ColorPalette>
  ...
  <ColorItem
    title="Hover"
    subtitle="Hoverable elements"
    colors={{ 
        Default: 'var(--bg-ui-hover)',
    }}
  />
</ColorPalette>
