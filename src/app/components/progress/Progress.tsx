...
export const Progress = ({ percentage = 0, text = "0/8", subtext = "completed", size="sm", addClass, style, ...props }: ProgressProps) => {
  let classTab = ["progress-circle-container flex-shrink-0"];
  size && classTab.push(`is-${size}`);
  addClass && classTab.push(addClass);

  return (
    <svg className={classTab.join(" ")} {...props} viewBox="0 0 32 32" data-percent={percentage} style={{ ["--percent" as any]: percentage, ...style }}>
