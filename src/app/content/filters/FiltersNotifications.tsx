...
export interface FiltersNotificationsProps {}

export const FiltersNotifications = ({}: FiltersNotificationsProps) => {
    // useEffect(() => {
    //     dropdownNotSaved();
    // }, []);
    return (
        <>
            <div id="tables-filters" className="d-flex flex-wrap align-items-sm-start gap-xs">
                <form className="d-flex flex-grow-1 flex-sm-grow-0 order-1">
                    <input name="search" autoComplete="off" type="search" id="search" className="form-control w-100 w-md-auto field-sizing" style={{ maxWidth: "100%" }} aria-describedby="search" placeholder="Search..." defaultValue="" />
                </form>
                <div className="d-flex flex-column flex-fill flex-sm-row gap-xs order-3 order-sm-2">
                    <div className="dropdown" data-save-to-close="true">
                        ...
                        <div className="dropdown-menu" style={{ width: 512, maxWidth: "calc(100% - 2rem)" }}>
                ...
                <div className="d-flex gap-xs order-2 order-sm-3">
                    <div className="d-flex gap-xs gap-sm-0px">
                        <div className="dropdown" data-toggle="tooltip" data-placement="top" data-original-title="Manage notifications subscriptions" data-boundary="window" data-save-to-close="true">
                            <a href="#" className="btn btn-lg btn-transparent btn-icon text-primary" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Manage notifications subscriptions" data-boundary="window">
                                <span className="icon icon-notifications-active" />
                            </a>
                            <div className="dropdown-menu dropdown-menu-right" style={{ width: 512, maxWidth: "calc(100% - 2rem)" }}>
                                <form className="d-flex flex-column gap-md px-16px py-8px">
                                    <div className="form-group d-flex flex-column gap-xs">
                                        ...
                                        <div id="sort1" className="d-flex gap-xs align-items-center">
                                            ...
                                            <div className="input-group">
                                                <div className="input-group-prepend" style={{ flex: "1 1 50%" }}>
                                                    <input type="number" className="form-control" id="validationDefault01" placeholder="Value" defaultValue="" />
                                                </div>
                                                <select name="filters" id="filter-select" className="filterSelect custom-select" style={{ flex: "1 1 50%" }}>
                                    ...
                                    <div className="form-group d-flex flex-column gap-xs">
                                        ...
                                        <div className="d-flex gap-md">
                                            ...
                                            <div className="custom-control custom-checkbox">
                                                <input className="custom-control-input" type="checkbox" id="email" defaultValue="email" defaultChecked />
                                                <label className="custom-control-label" htmlFor="email">
                                                    Email
                                                </label>
                                            </div>
                                            <div className="custom-control custom-checkbox">
                                                <input className="custom-control-input" type="checkbox" id="digest" defaultValue="digest" defaultChecked />
                        ...
                        <a href="#" className="btn btn-lg btn-transparent btn-icon text-muted" data-toggle="tooltip" data-placement="top" data-original-title="Download all data in this view" data-boundary="window">
