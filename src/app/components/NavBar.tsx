            ...
            <div className="flex-nowrap d-flex w-100">
              ...
              <div className="navbar-brand">
                <a
                  ...
                  data-toggle="tooltip"
                  href="#"
                  data-original-title="schoolab home"
                >
                  <img
              ...
              <div className="navbar-options ml-lg-auto">
                <div className="d-none d-lg-flex flex-fill">
                  <div className="navbar-option">
                    <a className="btn btn-lg navbar-main-btn active" href="#">
                      <span className="icon icon-school mr-2" />
                      <span>Programs</span>
                    </a>
                  </div>
                  <div className="navbar-option">
                    <a className="btn btn-lg navbar-main-btn" href="#">
                  ...
                  <div className="navbar-option">
                    <a className="btn btn-lg navbar-main-btn" href="#">
                      <span className="icon icon-account-group mr-2" />
                      <span>Community</span>
                    </a>
                  </div>
                  <div className="navbar-option">
                    <a className="btn btn-lg navbar-main-btn" href="#">
                      <span className="icon icon-calendar mr-2" />
                      <span>Events</span>
                    </a>
                  </div>
                  <div className="navbar-option">
                    <a className="btn btn-lg navbar-main-btn" href="#">
                      <span className="icon icon-newspaper mr-2" />
                      <span>Newsfeed</span>
                    </a>
                  </div>
                  <div className="navbar-option">
                    <a className="btn btn-lg navbar-main-btn" href="#">
                      <span className="icon icon-frequently-asked-questions mr-2" />
                      <span>F.A.Q.</span>
                    </a>
                  </div>
                </div>
                <div className="d-flex gap-xs align-items-center">
                  ...
                  <div className="navbar-option dropdown">
                    ...
                    >
                      <span
                        className="icon icon-bell has-dot"
                        title=""
                        data-toggle="tooltip"
                        data-content=""
                  ...
                  <div className="navbar-option dropdown d-none d-lg-flex ml-8px">
                    ...
                    >
                      <div
                        className="thumbnail is-md is-oval"
                        title=""
                        data-toggle="tooltip"
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                      <a className="dropdown-item d-flex">
                        ...
                        <div className="d-flex flex-column justify-content-center ml-4">
                          ...
                          <span className="small text-muted mb-none">
                            Head of Tests
                          </span>
                        </div>
                      </a>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="nofollow"
                        href="https://www.notion.so/Help-Center-INSIDE-7e56175d45bc47e8947e7584f2e3837d"
                      >
                        Help Center
                      </a>
                      <div className="dropdown-divider" />
