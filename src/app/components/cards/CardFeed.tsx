    ...
    return (
        <Card addClass={classTab.join(" ")} style={style} {...props}>
            <CardInfos addClass="d-flex flex-column align-items-stretch gap-md p-24px">
                {from && (
                    <p className="text-muted small gap-2xs">
                        <span>{fromPrepend}</span>{" "}
                ...
                {isFooterActions && (
                    <div className="d-flex justify-content-between flex-nowrap">
                        <div className="d-flex gap-xs flex-fill">
                            {liked ? <Button size="sm" type="secondary" label={likes} iconStartName="thumb-up" isActive={true} showActive={false} /> : <Button size="sm" type="secondary" label={likes > 0 ? likes : "Like"} iconStartName="thumb-up" showActive={false} />}

                            {commented ? <Button size="sm" type="secondary" label={comments} iconStartName="comment" /> : <Button size="sm" type="secondary" label={comments > 0 ? comments : "Comment"} iconStartName="comment" />}
                        </div>
